...
#         if self.left_distance_sensor and self.right_distance_sensor:
...
#         # Log differences
#         self.get_logger().debug(f"Delta Distance: {delta_distance}, Theta: {self.theta}")
