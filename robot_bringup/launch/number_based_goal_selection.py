...
class NavigateRobot(Node):
    def __init__(self):
        ...
        self.goal_positions = {
            0: {'name': 'Home', 'x': 2.3557, 'y': 1.4962, 'z': -0.6447, 'w': 0.7643},
            1: {'name': 'Sofa', 'x': 2.3557, 'y': 1.4962, 'z': -0.6447, 'w': 0.7643},
            2: {'name': 'TV', 'x': 4.8077, 'y': -0.2211, 'z': -0.9955, 'w': 0.0944},
            3: {'name': 'Door', 'x': 1.4015, 'y': -1.9879, 'z': 0.7466, 'w': 0.6652}
        }
